...
public class King extends Piece {
	...
	public List<Square> getMoves() {
		...
		if (getBoard().getSquare(7, 7).getPiece() != null) {
		...
		Square rookTestSquare = getBoard().getSquare(7, 7);
			if (!(getBoard().getSquare(4, 7).getPiece().hasKingCastled()) && !(getBoard().isInCheck())) {	
		...
		if (getBoard().getSquare(0, 7).getPiece() != null) {
		if (getSquare().getX() == 4 && getSquare().getY() == 7 && getColor() == "white"  && getSquare().getPiece().getName().compareTo("King")==0) {
		...
		if (getBoard().getSquare(7, 0).getPiece() != null) {
		...
		Square rookTestSquare = getBoard().getSquare(7, 0);
			if (!(getBoard().getSquare(4, 0).getPiece().hasKingCastled()) && !(getBoard().isInCheck())) {	
		...
		if (getBoard().getSquare(0, 0).getPiece() != null) {
